...
function generateCommandExecution(apiKey, device, attribute) {
    ...
    var encryptAlgorithm = 'aes-128-ccm';
    ...
    //console.log("Payload before zero padding text: ", payload, "\n");

    payload = customPadding(payload, 256, 0x0, "hex"); // magic happens here

    console.log("Payload AFTER zero padding text: ", payload, "\n");
    ...
    console.log("lwpubsubFirstByte", lwpubsubFirstByte, "iv: ", iv, "encr.: ", encryptedPayload);
